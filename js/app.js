(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            modules: [ Navigation, Controller, Thumb, Autoplay, EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 20,
        ...
        if (document.querySelector(".swiper-gifts")) new core(".swiper-gifts", {
        ...
        if (document.querySelector(".swiperrecomendation")) new core(".swiperrecomendation", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swipervideo")) new core(".swipervideo", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
